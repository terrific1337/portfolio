    ...
    @if($projects->count())
        @foreach($projects as $project)
            <div class="project-card">
                ...
                <img src="{{ asset($project->image) }}" alt="Project Screenshot" class="project-thumb">
                <h2>{{ $project->name }}</h2>
                ...
                <div class="project-links">
                    <a href="{{ $project->live_url }}" class="btn">Live Demo</a>
                    <a href="{{ $project->code_url }}" class="btn">View Code</a>
                </div>
            </div>
        @endforeach
    @else
